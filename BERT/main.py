...
if __name__ == "__main__":
    ...
    encoder = BertEncoder()
    decoder_embeddings = onmt.modules.Embeddings(opts.tgt_word_vec_size, len(tgt_vocab),
                                                 word_padding_idx=tgt_padding)
    decoder = onmt.decoders.transformer.TransformerDecoder.from_opt(opts, decoder_embeddings)
    ...
    model.generator = nn.Sequential(
        nn.Linear(opts.dec_rnn_size, len(tgt_vocab)),
